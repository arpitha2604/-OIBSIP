...
public class GuessingGame extends JFrame {
	...
	public void checkGuess() {
		...
		try {			
			...
			if (guess < theNumber) {
				message = guess + " is low try again";
				...
				message = guess + " Yay!! Finally you won :D";
				lblOutput.setText(message);
				newGame();
			}
			else{
	...
	public GuessingGame() {
		...
		lblTitle.setForeground(new Color(141,19,129));
		...
		lblGuessANumber.setForeground(new Color(141,19,129));
		...
		btnGuess.setForeground(new Color(255,204,229));
		btnGuess.setBackground(new Color(141,19,129));
		...
		lblOutput.setForeground(new Color(107,5,97));
